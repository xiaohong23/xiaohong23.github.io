...
function dowritenew(s){
 ...
 var newwin=open("blank.htm","jmol_"+sm,woptions)
...
function getscriptlink(i,isul){
 ...
 var s=(S.length>1?(isul?"</ul>":"")+"<table><tr>":"")
 //2> means colspan=2
...
function getscripts(){
 ...
 s=s.replace(/\<\/table\>\<\/ul\>\<ul\>\<table\>/g,"")
 if(s)s+="</ul>"
...
function gettitle(){
 ...
 s="<form action=\"\"><table width=\"800\"><tr><td>"+s+"</td><td>"+gettitleinfo()+"</td></tr></table></form>"
 return s
}
...
function getpage(){
 ...
 s+='\n<div id="aframe">'
	...
	+'\n</td></tr></table></div>'
	+'\n<div id="bframe">'
	+'\n<span id="jmolApplet">'+getapplet("jmol",model,codebase,height,width,loadscript+";"+Scripts[0],messagecallback,animcallback,pickcallback,loadstructcallback)+'\n</span>'
	+'\n<p><br />'+thecaption
